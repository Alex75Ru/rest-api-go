...
func (d *db) Update(ctx context.Context, user user.User) error {
	...
	// delete id from bson. don't need to update field "id"
	delete(updateUserObj, "_id")

	// create query on update
	update := bson.M{
		"$set": updateUserObj,
	}
	...
	d.logger.Tracef("Matched %documents and Modified %d documents", result.MatchedCount, result.ModifiedCount)
